        ...
        <div className="container text-center form-signin w-100 m-auto py-3">
            <div className="row featurette">
                <div className="col-md-7 order-md-2">
                    ...
                    <p className="lead">Hello everyone , my name is Rajarshi Ray. I am a 3rd year student currently pursuing my B-Tech in Biotechnology in University of Engineering & Kolkata.I have made this website as a project which acts a simple UI for calculating BMI and nutritional contents in a user's desired food along with an exercise guidance support which can be highly beneficial for maintaining proper health and well being.</p>
                ...
                <div className="col-md-5 order-md-1">
                    <img src={mypic} alt="Description of your image" class="bd-placeholder-img bd-placeholder-img-md featurette-image img-fluid mx-auto" width="400" height="400" style={{ border: "2px solid", borderRadius: "50%" }} />
                </div>
            </div>
        </div>
    )
